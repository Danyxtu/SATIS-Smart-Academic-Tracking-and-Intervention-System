...
Route::middleware(['auth', 'verified', 'can:access-teacher-portal'])
    ...
    ->group(function () {
        ...
        Route::post('/classes/archived/{archiveClass}/restore', [ClassController::class, 'restoreArchivedClass'])
            ->name('classes.archived.restore');
        ...
        Route::get('/students/search-by-lrn', [ClassController::class, 'globalSearchStudentByLrn'])
            ->name('students.search-by-lrn');
