                    ...
                    {mockAttendanceLog.map(log => (
                        <li key={log.id} className="p-4 sm:p-6">
                            <div className="flex flex-col sm:flex-row justify-between sm:items-center">
                                <div>
                                    <p className="text-lg font-semibold text-indigo-700">{log.className}</p>
                                ...
                                <div className="flex items-center gap-4 text-sm sm:gap-6">
                                    <span className="flex items-center gap-1.5 text-green-700">
                                        <Check size={16} /> 
                                        <span className="font-medium">{log.stats.present}</span>
                                        <span className="text-gray-600">Present</span>
                                    </span>
                                    <span className="flex items-center gap-1.5 text-red-700">
                                        <XIcon size={16} /> 
                                        <span className="font-medium">{log.stats.absent}</span>
                                        <span className="text-gray-600">Absent</span>
                                    </span>
                                    <span className="flex items-center gap-1.5 text-yellow-700">
                                        <Clock size={16} /> 
                                        <span className="font-medium">{log.stats.late}</span>
