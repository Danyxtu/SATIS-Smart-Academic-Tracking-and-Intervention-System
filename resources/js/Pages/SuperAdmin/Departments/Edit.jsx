                        ...
                        <div className="rounded-xl bg-gradient-to-br from-slate-50 to-slate-100 p-5 border border-slate-200">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="bg-white rounded-xl p-4 border border-slate-100 text-center">
                                    <div className="h-10 w-10 mx-auto rounded-lg bg-violet-100 flex items-center justify-center mb-2">
                                        <UserCog
                                            size={20}
                                ...
                                <div className="bg-white rounded-xl p-4 border border-slate-100 text-center">
                                    <div className="h-10 w-10 mx-auto rounded-lg bg-emerald-100 flex items-center justify-center mb-2">
                                        <Users
                                            size={20}
                                ...
                                <div className="bg-white rounded-xl p-4 border border-slate-100 text-center">
                                    <div className="h-10 w-10 mx-auto rounded-lg bg-amber-100 flex items-center justify-center mb-2">
                                        <GraduationCap
                                            size={20}
