...
export default function Edit({ subject, availablePrerequisites }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        grade_level: subject.grade_level?.toString() || "11",
        strand: subject.strand || "",
        track: subject.track || "",
        semester: subject.semester?.toString() || "1",
        units: subject.units?.toString() || "3",
        ...
        prerequisites:
            subject.prerequisites?.map((p) => ({
                ...
                name: p.name,
                code: p.code,
                minimum_grade: p.pivot?.minimum_grade || 75,
            })) || [],
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(route("superadmin.curriculum.update", subject.id));
    };
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500">
                            Update subject information and prerequisites
                        </p>
                    </div>
                </div>
                    ...
                    <div className="rounded-2xl bg-white shadow-sm border border-slate-100 overflow-hidden">
                        <div className="flex items-center gap-4 p-6 border-b border-slate-100 bg-slate-50/50">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500">
                                    Subjects that must be completed before this
                                    one
                                </p>
                            </div>
                        </div>
