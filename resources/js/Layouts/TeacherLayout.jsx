                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-4 sm:-my-px sm:ml-10 sm:flex">
                                {menuItems.map((item) => {
                                    ...
                                    const isActive = routeExists ? route().current(item.activeCheck) : false;

                                    return (
                                        <NavLink
                                            key={item.label}
                                            href={routeExists ? route(item.destination) : '#'}
                                            active={isActive}
                                            ...
                                            className={`inline-flex items-center gap-2 px-1 pt-1 border-b-2 text-sm font-medium
                                                ...
                                                ${ !routeExists ? 'cursor-not-allowed opacity-50' : '' }
                                            `}
                                        >
                                            {item.icon}
                                            {item.label}
                        ...
                        {menuItems.map((item) => {
                            ...
                            return (
                                <ResponsiveNavLink 
                                    ...
                                    href={routeExists ? route(item.destination) : '#'} 
                                    active={isActive}
                                    className={!routeExists ? 'cursor-not-allowed opacity-50' : ''}
                                >
