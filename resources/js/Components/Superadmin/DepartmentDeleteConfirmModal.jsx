...
export default function DepartmentDeleteConfirmModal({
    show,
    onClose,
    onConfirm,
    departmentName = "",
            ...
            <div className="space-y-4 px-5 py-4">
                ...
                <div>
                    <label className="mb-1 block text-xs font-semibold text-slate-700">
                        Type department name to confirm deletion
                    </label>
                    <input
                        type="text"
                        ...
                        placeholder="Paste or type the exact department name"
