...
import { StudentInterventionModal } from "@/Components/Teacher/Dashboard";
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 flex items-center justify-between transition-all hover:shadow-md">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button
                        ...
                        className="bg-indigo-600 text-white font-medium py-2 px-4 rounded-lg text-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed hover:bg-indigo-700"
                    >
                        {hasActiveIntervention
                            ? "Update Intervention"
                            : "Start Intervention"}
